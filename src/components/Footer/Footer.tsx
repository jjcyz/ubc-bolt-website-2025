      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 mb-8">
          ...
          <div className="flex flex-wrap items-center gap-6 text-sm">
            <button onClick={() => scrollToSection('About')} className="font-inter text-white/80 hover:text-white transition-colors">
              About
            </button>
            <button onClick={() => scrollToSection('Team')} className="font-inter text-white/80 hover:text-white transition-colors">
              Team
            </button>
            <button onClick={() => scrollToSection('Events')} className="font-inter text-white/80 hover:text-white transition-colors">
              Events
            </button>
            <button onClick={() => scrollToSection('Partners')} className="font-inter text-white/80 hover:text-white transition-colors">
              Partners
            </button>

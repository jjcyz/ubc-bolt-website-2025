      ...
      <div className="w-full">
        <div className="w-full flex flex-col items-center">
          <div className="relative w-full">
            <div className="w-full overflow-x-auto scrollbar-hide" ref={carouselRef} style={{ cursor: 'grab' }}>
              <div className="flex gap-8 py-4 animate-scroll-right"
                   style={{
                     animation: 'scroll-right 30s linear infinite'
                   }}>
                {[...allMembers, ...allMembers].map((member, index) => (
                  <div key={index} className="flex-shrink-0 flex flex-col items-center hover:-translate-y-2 transition-transform duration-300 cursor-pointer">
                    <div className="relative">
                      <div className={`w-32 h-32 rounded-full overflow-hidden border-2 border-gray-300 transition-opacity duration-300 ${
          ...
          <div className="mt-12">
            <button
              ...
              className="bg-black/10 hover:bg-black/20 text-black font-inter font-semibold px-8 py-3 rounded-full transition-all duration-200"
            >
              View More
            </button>
          </div>

...
const Hero: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-start bg-gradient-to-br from-[#1a0b2e] via-[#614ea5] to-[#493b7b] w-full h-screen min-h-screen px-4 md:px-16 relative overflow-hidden" id="Home">
      <SpaceScene />
      <Navbar />

      ...
      <div className="w-full max-w-6xl mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {EVENTS.slice(0, 4).map((event, index) => {
            ...
            return (
            <div key={index} className="bg-white/20 backdrop-blur-lg rounded-xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group">
              ...
              <div className="space-y-3">
                <h3 className="font-inter text-gray-800 font-bold text-lg">{event.name}</h3>
                ...
                <div className="flex justify-center pt-2">
                  <button
                    ...
                    className="bg-white/20 hover:bg-white/30 text-gray-800 font-inter font-semibold px-4 py-2 rounded-full transition-all duration-200 border border-gray-300/50"
                  >
                    Learn More
                  </button>
                </div>

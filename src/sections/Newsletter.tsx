...
const Newsletter: React.FC = () => {
  ...
  return (
    <section className="w-full py-16 flex items-center justify-center bg-gradient-to-r from-[#614ea5] to-[#493b7b]" id="Newsletter">
      <div className="max-w-6xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                    <div className="text-white text-left max-w-lg">
                      ...
                      <h1 className="font-inter text-3xl font-bold mb-6 leading-tight">Stay Connected</h1>
        ...
        <div className="flex justify-end">
          <form onSubmit={handleSubmit} className="w-full max-w-md">
            <div className="bg-white/20 backdrop-blur-lg rounded-full p-2 shadow-lg flex">
              <input
                type="email"
                value={email}
              ...
              <button
                type="submit"
                className="bg-white/20 backdrop-blur-md text-white font-inter font-semibold px-6 py-3 rounded-full hover:bg-white/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm"
